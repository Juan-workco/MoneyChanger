                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        class="form-control group-name-select {{ $errors->has('group_name') ? 'is-invalid' : '' }}"
                                        id="group_name" name="group_name">
                                        <option value=""></option>
                                        @foreach($existingGroups as $group)
                                            <option value="{{ $group }}" {{ old('group_name', $customer->group_name) == $group ? 'selected' : '' }}>{{ $group }}</option>
                                        @endforeach
                                        @if($customer->group_name && !$existingGroups->contains($customer->group_name))
                                            <option value="{{ $customer->group_name }}" selected>{{ $customer->group_name }}
                                            </option>
                                        @endif
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">Enter contact details (WeChat, WhatsApp, Telegram,
                                        etc.)</small>
